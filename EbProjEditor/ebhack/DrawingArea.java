 ...
 * @author AnyoneEB
 */
public abstract class DrawingArea extends JComponent
  ...
  public interface Palette {
    /**
     * Gets the selected item in this Palette. Named colorIndex to avoid confusion
     * with other methods.
     * 
    ...
    /**
     * Sets the selected item in this Palette. Named colorIndex to avoid confusion
     * with other methods.
     * 
  ...
  /**
   * Interface to identify a toolset for a drawing area. Includes final ints for
  ...
  public interface Toolset {
    ...
    public static final int TOOL_PENCIL = 1, TOOL_LINE = 2, TOOL_RECTANGLE = 3, TOOL_ROUND_RECTANGLE = 4, TOOL_OVAL = 5,
    ...
    /**
     * Fill types for (round) retangle and oval. Fill with the same color as the
     * outline.
     */
    ...
    /**
     * Returns true if transparent pixels should be treated as transparent when
     * dragging selections. This may be an user-selected option.
     * 
     * @return True if transparent pixels should be treated as transparent when
     *         dragging selections.
     */
  ...
  /**
   * Consturctor for DrawingArea. Adds a MouseListener and a MouseMotionListener
   * to this.
   */
  public DrawingArea() {
