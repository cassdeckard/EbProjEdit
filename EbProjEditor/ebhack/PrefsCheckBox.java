...
public class PrefsCheckBox extends JCheckBoxMenuItem {
    ...
    super.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
        ...
        for (Iterator i = listeners.iterator(); i.hasNext();) {
          ((ActionListener) i.next()).actionPerformed(new ActionEvent(this, 0, getActionCommand()));
        }
      }
    });
  }
  ...
  /**
   * Contructor a <code>JCheckBox</code> with a given title and preference to edit
  ...
  /**
   * Contructor a <code>JCheckBox</code> with a given title and preference to
   * edit.
   * 
   * @param label text to label this with
   * @param prefs class hold preferences
   ...
   */
  public PrefsCheckBox(String label, YMLPreferences prefs, String pref, boolean def) {
    super(label, def);
    this.prefs = prefs;
    this.pref = pref;
    this.defVal = def;
  ...
  public PrefsCheckBox(String label, YMLPreferences prefs, String pref, boolean def, char m) {
    this(label, prefs, pref, def);
    this.setMnemonic(m);
  }

  public PrefsCheckBox(String label, YMLPreferences prefs, String pref, boolean def, char m, String key) {
    this(label, prefs, pref, def, m);
    if (key != null)
      this.setAccelerator(KeyStroke.getKeyStroke(key));
  }

  public PrefsCheckBox(String label, YMLPreferences prefs, String pref, boolean def, char m, String key, String ac,
      ActionListener al) {
